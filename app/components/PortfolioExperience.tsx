...
export default function PortfolioExperience({ projectItems }: { projectItems: Project[] }) {
  ...
  return <div className="portfolio-next">
    ...
    <section id="about" className="section-next statement shell" data-index="02">
      ...
      <div className="position-sculpture" aria-hidden="true" onPointerMove={moveSculpture} onPointerLeave={resetSculpture}><div className="sculpture-axis axis-x"/><div className="sculpture-axis axis-y"/><div className="sculpture-scene"><div className="sculpture-orbit orbit-a"/><div className="sculpture-orbit orbit-b"/><i data-layer="PRODUCT"/><i data-layer="ENGINEERING"/><i data-layer="MANAGEMENT"/><div className="sculpture-core"><span>P</span><span>E</span><span>M</span></div></div><b>PRODUCT<br/>× ENGINEERING<br/>× MANAGEMENT</b><small>MOVE / TILT / ASSEMBLE</small></div>
